...
HD_PWD='/home/pedro.rosso/stencil/stencil/Heat2D/Heat2D.runs/SR32Lat15_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SR32Lat15.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SR32Lat15.tcl

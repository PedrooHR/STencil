...
HD_PWD='/home/pedro.rosso/stencil/stencil/Heat2D/Heat2D.runs/BR1024FIFO16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BR1024FIFO16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BR1024FIFO16.tcl

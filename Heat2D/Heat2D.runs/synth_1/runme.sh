...
HD_PWD='/home/pedro.rosso/stencil/stencil/Heat2D/Heat2D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Heat2D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Heat2D.tcl

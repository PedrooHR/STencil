...
HD_PWD='/home/pedro.rosso/stencil/stencil/Heat3D/Heat3D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Heat3D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Heat3D.tcl

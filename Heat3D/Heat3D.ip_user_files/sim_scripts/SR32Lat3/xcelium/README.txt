...
#
# Generated by export_simulation on Wed Mar 26 10:46:02 -03 2025
#
################################################################################
...
'-reset_run' switch to the './SR32Lat3.sh' script.

./SR32Lat3.sh -reset_run
...
./SR32Lat3.sh -noclean_files

For more information on the script, please type './SR32Lat3.sh -help'.

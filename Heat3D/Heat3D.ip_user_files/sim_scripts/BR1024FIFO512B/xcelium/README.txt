...
#
# Generated by export_simulation on Wed Mar 26 12:57:43 -03 2025
#
################################################################################
...
'-reset_run' switch to the './BR1024FIFO512B.sh' script.

./BR1024FIFO512B.sh -reset_run
...
./BR1024FIFO512B.sh -noclean_files

For more information on the script, please type './BR1024FIFO512B.sh -help'.

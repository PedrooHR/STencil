...
HD_PWD='/home/pedro.rosso/stencil/stencil/Jacobi3D/Jacobi3D.runs/BR1024FIFO512B_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BR1024FIFO512B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BR1024FIFO512B.tcl

...
HD_PWD='/home/pedro.rosso/stencil/stencil/Jacobi3D/Jacobi3D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jacobi3D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jacobi3D.tcl

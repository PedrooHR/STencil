...
#
# Generated by export_simulation on Sat Dec 28 23:30:12 -03 2024
#
################################################################################
...
'-reset_run' switch to the './SR32Lat7.sh' script.

./SR32Lat7.sh -reset_run
...
./SR32Lat7.sh -noclean_files

For more information on the script, please type './SR32Lat7.sh -help'.

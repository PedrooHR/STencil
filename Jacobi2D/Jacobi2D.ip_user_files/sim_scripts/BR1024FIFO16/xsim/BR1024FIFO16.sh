...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L fifo_generator_v13_2_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BR1024FIFO16 xil_defaultlib.BR1024FIFO16 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BR1024FIFO16 -key {Behavioral:sim_1:Functional:BR1024FIFO16} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BR1024FIFO16.wdb xsim.dir)

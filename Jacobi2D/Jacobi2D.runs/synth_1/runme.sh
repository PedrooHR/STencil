...
HD_PWD='/home/pedro.rosso/stencil/stencil/Jacobi2D/Jacobi2D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jacobi2D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jacobi2D.tcl

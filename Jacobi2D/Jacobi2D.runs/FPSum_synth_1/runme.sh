...
HD_PWD='/home/pedro.rosso/stencil/stencil/Jacobi2D/Jacobi2D.runs/FPSum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPSum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPSum.tcl

...
HD_PWD='/home/pedro.rosso/stencil/stencil/Heat1D/Heat1D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Heat1D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Heat1D.tcl

...
HD_PWD='/home/pedro.rosso/stencil/stencil/Jacobi1D/Jacobi1D.runs/SR32Lat7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SR32Lat7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SR32Lat7.tcl

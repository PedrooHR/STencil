...
HD_PWD='/home/pedro.rosso/stencil/stencil/Jacobi1D/Jacobi1D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jacobi1D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jacobi1D.tcl
